...
folder_path="/home/gxm020/171240ms/"
folders=glob.glob(folder_path+'*') # see the * appended at the end
folder_name="results_unisensory_alpha_range1" #the name to be given to the folder containing results
...
for folder in folders:
	...
	dt=dt[range(0,2000),:] #taking the minimum time range out of all the files
	print f
	print '\n\n'
